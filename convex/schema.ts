...
export default defineSchema({
  ...
  workouts: defineTable({
    ...
    status: v.union(v.literal('scheduled'), v.literal('in_progress'), v.literal('completed'), v.literal('skipped')),
    created_at: v.number(),
  }),
  ...
  messages: defineTable({
    conversation_id: v.string(), // Changed to string to match existing data
    sender_id: v.string(), // Changed to string to match existing data
    content: v.string(),
    created_at: v.number(), // Changed to match existing data
    is_read: v.boolean(), // Changed to boolean to match existing data
  }),
  ...
  posts: defineTable({
    ...
    comments: v.optional(v.array(v.object({ // Made optional to match existing data
